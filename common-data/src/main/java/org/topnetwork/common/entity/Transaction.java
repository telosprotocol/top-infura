...
public class Transaction extends Model<Transaction> {
    ...
    private String lastTxNonce;

    /**
     * 交易体大小
     */
    @TableField("tx_len")
    private String txLen;
    ...
    private String recvUsedDeposit;

    /**
     * recv_used_gas
     */
    @TableField("recv_used_gas")
    private String recvUsedGas;

    /**
     * recv_used_disk
     */
    @TableField("recv_used_disk")
    private String recvUsedDisk;

    /**
     * send_used_deposit
     */
    @TableField("send_used_deposit")
    private String sendUsedDeposit;

    /**
     * send_used_gas
     */
    @TableField("send_used_gas")
    private String sendUsedGas;

    /**
     * send_used_disk
     */
    @TableField("send_used_disk")
    private String sendUsedDisk;
